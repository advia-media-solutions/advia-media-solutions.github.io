...
const PageHelmet = () => {
  ...
  return (
    <Helmet>
      ...
      <meta name="description" content={getDescriptionForRoute(location.pathname)} />
      <meta property="og:title" content={getTitleForRoute(location.pathname)} />
      <meta property="og:description" content={getDescriptionForRoute(location.pathname)} />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={`https://www.advia.tech${location.pathname}`} />
      <meta name="twitter:card" content="summary_large_image" />
      <link rel="canonical" href={`https://www.advia.tech${location.pathname}`} />
    </Helmet>
  );
};
